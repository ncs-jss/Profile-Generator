...
class userDetails(models.Model):
	...
	project_url = models.CharField(max_length=10000, blank=True, null=True)
	...
	achieve_year=models.CharField(max_length=10000)
	...
	cv=models.FileField(upload_to="attachments")